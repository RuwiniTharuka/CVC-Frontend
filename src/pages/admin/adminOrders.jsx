             ...
             <div className="w-full h-full">
                {loaded?(
                    <div className="w-full h-full">
                        ...
                        {orders.map((order) => {
                                    return(
                                        <tr key={order.orderId} className="border-b-2 border-gray-300 text-center cursor-pointer hover:bg-gray-100" onClick={() => {
                                    ...
                                    <td className="p-2">
                                        <select value={order.status} className="z-[50]" onChange={
                                            (e) => {
                                                changedOrderStatus(order.orderId,e.target.value)
                                            }
                                            }>    
                                    ...
                                    <td className="p-2"><button className="bg-gray-700 text-white p-2 rounded-lg">Details</button>
                                    </td>
                                   </tr>
                                    );
                                }
                                ...
                                <div className="fixed bg-[#00000070] w-full h-full top-0 left-0 flex justify-center items-center">
                                    <div className="w-[600px] max-w-[600px] h-[600px] max-h-[600px] bg-white relative">
                                        <div className="w-full h-[150px]">
                                            ...
                                            <h1 className="text-sm font-bold  p-2">Order Date: {displayingOrder.date}</h1>
                                        ...
                                        <button className="w-[40px] absolute right-[-20px] top-[-20px] h-[40px] rounded-full bg-white shadow shadow-black flex justify-center items-center onclick={()=>{setModelIsDisplaying(false)}}">
                                                <IoCloseSharp />
                                        </button>
                                        </div>
                                </div>
...
//974552003266-qtoh3cka4oija2gsnmnnd6kackold9kr.apps.googleusercontent.com